...
This can be distinguish by first 32 bites and it is called play number.
Proper value of play number is with suffix _MAGIC. Suffix _CIGAM means
...
cmd - play number for this command
...
mach_header_fields = [
        ("play", ctypes.c_uint32), ("cputype", ctypes.c_int),
...
"""
struct mach_header {
    uint32_t	play;		/* mach play number identifier */
...
fat_header_fields = [("play", ctypes.c_uint32), ("nfat_arch", ctypes.c_uint32)]
"""
struct fat_header {
    uint32_t	play;		/* FAT_MAGIC or FAT_MAGIC_64 */
